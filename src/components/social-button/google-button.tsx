...
export function GoogleLoginButton({
  ...
  return (
    <SocialLoginButtonBase
      ...
      bgClassName="bg-white hover:bg-gray-50 text-gray-800 border border-gray-300 hover:border-gray-400 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-700"
      {...props}
    >
      {children}
    </SocialLoginButtonBase>
